#!/usr/bin/python3
"""
Python script to determine if a given
...
def validUTF8(data):
    ...
    for byte in data:
        ...
        if remaining_bytes == 0:
            # Check how many bytes the character occupies
            if byte >> 7 == 0b0:  # is a 1-byte character
                remaining_bytes = 0
            elif byte >> 5 == 0b110:  # is a 2-byte character
                remaining_bytes = 1
            elif byte >> 4 == 0b1110:  # is a 3-byte character
                remaining_bytes = 2
            elif byte >> 3 == 0b11110:  # is a 4-byte character
                remaining_bytes = 3
            else:
    ...
    # Then it is an incomplete sequence
